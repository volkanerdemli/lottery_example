...
def get_contract(contract_name):
    """ This function will grab the contract addresses from the brownie config it defined,
    ...
    Returns:
        brownie.network.contract.ProjectContract: The mostly recently deployed version of 
        this contract
    """
    ...
    if network.show_active() in LOCAL_BLOCKCHAIN_ENVIRONMENTS:
        ...
        # MockV3Aggregator[-1] == contract_type[-1]
...
def fund_with_link(contract_address, account=None, link_token=None, amount=100000000000000000): #0.1LINK
    ...
    tx = link_token.transfer(contract_address, amount, {"from": account, "gasLimit": 10000000000000000000000000})
